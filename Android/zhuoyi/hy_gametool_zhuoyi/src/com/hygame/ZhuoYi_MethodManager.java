...
public class ZhuoYi_MethodManager extends HY_UserManagerBase implements
	...
	private static ZhuoYi_MethodManager instance;
	...
	private ZhuoYi_MethodManager() {
		mChannelUserInfo = new HY_UserInfoVo();
	}

	public static ZhuoYi_MethodManager getInstance() {
		if (instance == null) {
			instance = new ZhuoYi_MethodManager();
		}
		return instance;
	}
...
//		super.onActivityResult(paramActivity, requestCode, resultCode, data);
	...
	public void setRoleData(Activity paramActivity, HY_GameRoleInfo gameRoleInfo) {
		...
		ZhuoYi_RoleInfo.typeId = gameRoleInfo.getTypeId();// 上传类型
															// 登录:HY_Constants.ENTER_SERVER
															// 、创角:HY_Constants.CREATE_ROLE、升级:HY_Constants。LEVEL_UP
		ZhuoYi_RoleInfo.roleId = gameRoleInfo.getRoleId();// 角色id
		ZhuoYi_RoleInfo.roleName = gameRoleInfo.getRoleName();// 角色名
		ZhuoYi_RoleInfo.roleLevel = gameRoleInfo.getRoleLevel();// 角色等级
		ZhuoYi_RoleInfo.zoneId = gameRoleInfo.getZoneId();// 区服id
		ZhuoYi_RoleInfo.zoneName = gameRoleInfo.getZoneName();// 区服名
		ZhuoYi_RoleInfo.balance = gameRoleInfo.getBalance(); // 用户余额
		ZhuoYi_RoleInfo.vip = gameRoleInfo.getVip();// vip等级
		ZhuoYi_RoleInfo.partyName = gameRoleInfo.getPartyName();// 帮派名称

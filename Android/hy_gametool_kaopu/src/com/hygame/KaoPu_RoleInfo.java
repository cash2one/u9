...
//		String a = "typeId="+typeId+"&roleId="+roleId+"&roleName="+roleName+
//		"&roleLevel="+roleLevel+"&zoneId="+zoneId+"&zoneName="+zoneName+"&balance="+
//				+balance+"&vip="+vip+"&partyName="+partyName;
//		HyLog.d(TAG, a);
//		return a;
//	}
}

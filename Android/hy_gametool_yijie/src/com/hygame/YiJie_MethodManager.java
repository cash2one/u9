...
public class YiJie_MethodManager extends HY_UserManagerBase implements
		HY_AccountListener, HY_UserInfoListener {
	private static final String TAG = "HY";
	private static YiJie_MethodManager instance;
	...
	private YiJie_MethodManager() {
		mChannelUserInfo = new HY_UserInfoVo();
	}

	public static YiJie_MethodManager getInstance() {
		if (instance == null) {
			instance = new YiJie_MethodManager();
		}
		return instance;
	}
	...
	public void onCreate(Activity paramActivity) {
		mActivity = paramActivity;
		SFOnlineHelper.onCreate(paramActivity, new SFOnlineInitListener() {
			@Override
	...
	public void doLogin(final Activity paramActivity,
		...
		SFOnlineHelper.setLoginListener(paramActivity,
				new SFOnlineLoginListener() {
					@Override
		...
		SFOnlineHelper.login(paramActivity, "Login");
	...
	public void doLogout(final Activity paramActivity, Object object) {
		isLogout = true;
		SFOnlineHelper.logout(paramActivity, "LoginOut");
	}
	...
	public void setRoleData(Activity paramActivity, HY_GameRoleInfo gameRoleInfo) {
		...
		YiJie_RoleInfo.typeId = gameRoleInfo.getTypeId();// 上传类型
															// 登录:HY_Constants.ENTER_SERVER
															// 、创角:HY_Constants.CREATE_ROLE、升级:HY_Constants。LEVEL_UP
		YiJie_RoleInfo.roleId = gameRoleInfo.getRoleId();// 角色id
		YiJie_RoleInfo.roleName = gameRoleInfo.getRoleName();// 角色名
		YiJie_RoleInfo.roleLevel = gameRoleInfo.getRoleLevel();// 角色等级
		YiJie_RoleInfo.zoneId = gameRoleInfo.getZoneId();// 区服id
		YiJie_RoleInfo.zoneName = gameRoleInfo.getZoneName();// 区服名
		YiJie_RoleInfo.balance = gameRoleInfo.getBalance(); // 用户余额
		YiJie_RoleInfo.vip = gameRoleInfo.getVip();// vip等级
		YiJie_RoleInfo.partyName = gameRoleInfo.getPartyName();// 帮派名称

...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		HY_GameProxy.getInstance().setUserListener(this, new HY_UserListener() {
			...
			public void onLogout(int resultCode, Object paramObject) {
				...
				default:
					Toast.makeText(MainActivity.this, "注销失败", Toast.LENGTH_LONG)
							.show();
					HyLog.d(TAG, "注销失败");
					break;
				}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		HY_GameProxy.getInstance().onActivityResult(this, requestCode,
				resultCode, data);
	}
	...
	private void doLogOn() {
		...
		HY_GameProxy.getInstance().logon(MainActivity.this,
				new HY_LoginCallBack() {
	...
	private void doPay() {
		...
		payParams
				.setCallBackUrl("http://115.159.37.88:8022/upc/payCenter4U9.jsp");// 回调地址
		payParams.setGameOrderId("game" + time);// 订单号
		payParams.setAppExtInfo("支付回调拓展字段");

		HY_GameProxy.getInstance().startPay(MainActivity.this, payParams,
				new HY_PayCallBack() {
					@Override
